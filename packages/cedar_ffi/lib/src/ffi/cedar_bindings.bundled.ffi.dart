...
@ffi.Native<ffi.Void Function(ffi.Pointer<imp1.CedarStore>)>(isLeaf: true)
...
@ffi.Native<
    imp1.CAuthorizationDecision Function(ffi.Pointer<imp1.CedarStore>,
        ffi.Pointer<imp1.CCedarQuery>)>(isLeaf: true)

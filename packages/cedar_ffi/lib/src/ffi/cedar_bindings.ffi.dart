...
external CInitResult cedar_init(ffi.Pointer<CCedarConfig> config);
...
external void cedar_deinit(ffi.Pointer<CedarStore> store);
...
@ffi.Native<
  CAuthorizationDecision Function(
    ffi.Pointer<CedarStore>,
    ffi.Pointer<CCedarQuery>,
  )
>(isLeaf: true)
